		    ...
		    <article class="ss1-ss4 ms1-ms6 ls1-ls12">
		      ...
		      <section class="error-404 not-found">
				...
				<div class="page-content">
					...
					<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'tm-events-2016' ); ?></h2>
					<ul>
					<?php
					...
					<?php
						...
						$archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'tm-events-2016' ), convert_smilies( ':)' ) ) . '</p>';
