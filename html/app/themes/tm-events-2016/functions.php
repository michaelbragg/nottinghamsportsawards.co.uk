 ...
 *
 * @param array $vars List of allowed variables from filter.
 */
...
body.login div#login h1 a {
	width: 272px;
	height: 96px;
	background-image: url('<?php echo esc_url( get_template_directory_uri() . '/gui/logo_wp-admin.png' ); ?>');
	background-size: 100%;
}
.login #nav {
...
add_action( 'login_enqueue_scripts', 'admin_login_branding', 5 );
