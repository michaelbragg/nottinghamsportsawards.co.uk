 ...
 *
 * @package    TM_NSA_2016
 * @subpackage TM_NSA_2016/inc
 */

/**
 * Register all actions and filters for the Theme_Installer_Skin::before.
 *
 * Maintain a list of all hooks that are registered throughout
 * the Theme_Installer_Skin::before, and register them with the WordPress API. Call the
 * run function to execute the list of actions and filters.
 *
 * @package    TM_NSA_2016
 * @subpackage TM_NSA_2016/inc
 */
class TM_NSA_2016_Loader {
	/**
